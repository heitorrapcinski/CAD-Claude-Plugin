---
name: knowledge-vault-doc-investigations
...
# knowledge-vault-doc-investigations — Investigations (11) (substrato neutro)
...
## Contexto / conflito
- [[EV-5-007 · Aprovação exige duas alçadas|EV-5-007]] (normativo) diz **duas** alçadas.
- [[EV-5-011 · Código implementa uma alçada|EV-5-011]] (código) implementa **uma**.
